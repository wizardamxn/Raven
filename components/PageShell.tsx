...
export default function PageShell({ children }: { children: React.ReactNode }) {
  return (
    ...
    <div className="flex flex-col min-h-screen items-center justify-start bg-[#040406] font-sans text-zinc-200 pt-32 pb-24 selection:bg-purple-900/60 selection:text-purple-200">
      <GothicTree />
