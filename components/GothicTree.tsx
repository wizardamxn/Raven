...
export default function GothicTree() {
  return (
    ...
    >
      ...
      <div className="absolute -right-12 bottom-0 h-full w-[130%] bg-[radial-gradient(ellipse_at_70%_60%,rgba(216,58,69,0.06)_0%,rgba(216,58,69,0)_65%)]" />
      <Image
        src="/treeRightFinal.png"
        alt=""
        fill
        sizes="384px"
        className="object-contain object-bottom-right drop-shadow-[0_0_20px_rgba(216,58,69,0.14)]"
      />
      ...
      <span className="absolute right-[55%] top-[35%] h-1 w-1 rounded-full bg-ember-400 shadow-[0_0_8px_2px_rgba(216,58,69,0.45)] animate-[candle-flicker_9s_ease-in-out_infinite]" />
    </div>
  );
}
