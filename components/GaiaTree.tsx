...
export default function GaiaTree() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-linear-to-b from-ink-950/95 via-ink-950/60 to-ink-950" />
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_120%_80%_at_50%_38%,transparent_22%,rgba(6,4,10,0.82)_100%)]" />
      ...
      <div className="absolute right-5 top-20 md:hidden opacity-80">
        <div className="absolute -inset-10 rounded-full bg-[radial-gradient(circle,rgba(246,249,255,0.12)_0%,rgba(246,249,255,0)_70%)]" />
        <svg viewBox="0 0 120 120" className="relative h-20 w-20">
          <circle cx="60" cy="60" r="32" fill="rgba(246,249,255,0.16)" stroke="rgba(218,227,244,0.45)" strokeWidth="1" />
          <circle cx="60" cy="60" r="46" fill="none" stroke="rgba(218,227,244,0.35)" strokeWidth="0.8" strokeDasharray="3 9" />
        </svg>
      </div>
      ...
      <ParallaxLayer speed={0.1} className="absolute right-[-4vw] top-[4vh] h-[80vh] w-[30vw] hidden md:block">
        <div className="h-full w-full origin-top-right rotate-18 blur-3xl bg-linear-to-b from-[rgba(246,249,255,0.07)] via-[rgba(246,249,255,0.025)] to-transparent" />
      </ParallaxLayer>

      {/* Soft light bloom crowning the tome's arch */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 h-[38vh] w-[60vw] bg-[radial-gradient(ellipse_at_50%_0%,rgba(218,227,244,0.07)_0%,rgba(218,227,244,0)_65%)]" />
      ...
      >
        ...
        <g className="motion-safe:animate-[candle-flicker_11s_ease-in-out_infinite]">
          <circle cx="1034" cy="212" r="17" fill="rgba(218,227,244,0.10)" stroke="rgba(218,227,244,0.35)" strokeWidth="1" />
          <circle cx="1034" cy="212" r="6" fill="none" stroke="rgba(218,227,244,0.3)" strokeWidth="0.8" />
          <path
            d="M1034 195 L1034 229 M1017 212 L1051 212 M1022 200 L1046 224 M1046 200 L1022 224"
            stroke="rgba(218,227,244,0.28)"
            strokeWidth="0.8"
          />
        </g>
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 h-[42vh] w-[95vw] bg-[radial-gradient(ellipse_at_50%_100%,rgba(218,227,244,0.12)_0%,rgba(218,227,244,0.04)_45%,rgba(218,227,244,0)_70%)] motion-safe:animate-[candle-flicker_9s_ease-in-out_infinite]" />
