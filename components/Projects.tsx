            ...
            <TiltCard className="aspect-video">
              <div className="relative w-full h-full transition-transform duration-500 group-hover/card:-translate-y-1">
                <ViewTransition name={`relic-${project.id}`} share="morph">
                  <div className="relative w-full h-full rounded-xl overflow-hidden bg-ink-800 border border-gilt transition-all duration-500 group-hover/card:border-gilt-strong group-hover/card:shadow-[0_8px_32px_rgba(216,58,69,0.14)]">
                    <Image
                      src={project.image}
                      alt={project.title}
                      fill
