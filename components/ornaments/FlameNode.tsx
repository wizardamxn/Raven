  ...
  return (
    ...
    >
      ...
      <svg
        ...
        viewBox="0 0 22 30"
        fill="none"
        className={`relative transition duration-300 group-hover:brightness-125 group-hover:drop-shadow-[0_0_10px_rgba(79,124,240,0.7)] ${
      ...
      >
        ...
        <path
          ...
          fill={current ? "rgba(79,124,240,0.85)" : "rgba(168,157,133,0.5)"}
          stroke={current ? "#8fb4ff" : "#6e6553"}
          strokeWidth="1"
        />
        {/* Inner flame */}
        <path
          d="M11 8 C12.6 10.5 14 11.8 14 14 A3 3 0 0 1 8 14 C8 11.8 9.4 10.5 11 8 Z"
          fill={current ? "#cdddff" : "rgba(221,210,186,0.4)"}
        />
        {/* Candle base */}
        <rect x="8" y="21" width="6" height="7" rx="1" fill={current ? "rgba(23,16,33,0.9)" : "rgba(23,16,33,0.7)"} stroke={current ? "rgba(79,124,240,0.5)" : "rgba(110,101,83,0.5)"} strokeWidth="0.8" />
      </svg>
    </span>
  );
}
