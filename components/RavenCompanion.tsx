    ...
    return (
      <div
        ...
        style={{
          ...
          filter: "drop-shadow(0 0 22px rgba(216,58,69,0.28))",
        }}
      >
        <Image
          src="/download.png"
    ...
    >
      <svg
        ...
        className={`w-full h-full overflow-visible
                    [filter:drop-shadow(0_2px_6px_rgba(0,0,0,0.8))_drop-shadow(0_0_12px_rgba(216,58,69,0.3))]
      ...
      >
        ...
        >
          ...
          <circle cx="13.5" cy="13.5" r="3.2" fill="rgba(216,58,69,0.25)" />
          <circle
            className="raven-eye"
            cx="13.5"
            cy="13.5"
            ...
            fill="#d83a45"
          />
          <circle cx="14" cy="13" r="0.5" fill="#ffd6d9" />
        </g>
      </svg>
    </button>
  );
