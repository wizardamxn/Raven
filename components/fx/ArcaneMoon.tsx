...
export default function ArcaneMoon() {
  ...
  return (
    <div ref={wrapRef} style={{ "--moon-glow": "0" } as React.CSSProperties}>
      {/* Wide halo */}
      <div className="absolute -inset-28 rounded-full bg-[radial-gradient(circle,rgba(255,214,217,0.14)_0%,rgba(255,214,217,0.05)_45%,rgba(255,214,217,0)_70%)]" />
      {/* Awakened halo — blooms as the cursor nears */}
      <div
        className="absolute -inset-28 rounded-full bg-[radial-gradient(circle,rgba(255,214,217,0.18)_0%,rgba(255,214,217,0.06)_45%,rgba(255,214,217,0)_70%)] transition-opacity duration-500"
      ...
      <svg viewBox="0 0 160 160" className="relative h-36 w-36 lg:h-44 lg:w-44">
        <defs>
          <radialGradient id="moon-glow" cx="0.42" cy="0.4" r="0.75">
            ...
            <stop offset="0.55" stopColor="rgba(255,214,217,0.35)" />
            <stop offset="1" stopColor="rgba(216,58,69,0.18)" />
          </radialGradient>
        </defs>
        {/* Luminous disc */}
        ...
        >
          ...
          <path d="M80 18 L83 24 L80 28 L77 24 Z" fill="rgba(216,58,69,0.55)" stroke="none" />
          <path d="M80 142 L83 136 L80 132 L77 136 Z" fill="rgba(216,58,69,0.55)" stroke="none" />
          <path d="M18 80 L24 83 L28 80 L24 77 Z" fill="rgba(216,58,69,0.55)" stroke="none" />
          <path d="M142 80 L136 83 L132 80 L136 77 Z" fill="rgba(216,58,69,0.55)" stroke="none" />
        </g>
      </svg>
