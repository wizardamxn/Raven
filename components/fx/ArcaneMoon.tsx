...
export default function ArcaneMoon() {
  ...
  return (
    <div ref={wrapRef} style={{ "--moon-glow": "0" } as React.CSSProperties}>
      ...
      <div
        className="absolute -inset-28 rounded-full bg-[radial-gradient(circle,rgba(246,223,164,0.18)_0%,rgba(246,223,164,0.06)_45%,rgba(246,223,164,0)_70%)] transition-opacity duration-500"
