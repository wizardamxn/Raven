  ...
  return (
    <div className="flex justify-center mb-10">
      ...
      >
        ...
        <span
          aria-hidden
          className="absolute -inset-3 rounded-full bg-[radial-gradient(circle,rgba(216,58,69,0.25)_0%,rgba(216,58,69,0)_70%)] opacity-0 group-hover:opacity-100 transition-opacity duration-500"
        />
