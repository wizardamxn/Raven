      ...
      >
        ...
        <Reveal className="w-full">
          <div id="chronicles" className="w-full text-left max-w-xl mx-auto scroll-mt-28 mt-6">
            ...
            <div className="flex flex-col gap-10 relative ml-4 pl-6 border-l border-transparent [border-image:linear-gradient(to_bottom,rgba(218,227,244,0.5),rgba(218,227,244,0.08))_1]">
