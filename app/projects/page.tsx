              ...
              <div className="flex flex-wrap gap-3 mt-6">
                {project.technologies.map((tech) => (
                  <div key={tech.name} className="relative group/tech">
                    ...
                    {/* Icon Container */}
                    <span className="flex items-center justify-center w-9 h-9 rounded-lg bg-ink-800/70 border border-gilt text-parchment-300 transition-all duration-200 hover:text-ember-300 hover:border-gilt-strong hover:shadow-[0_0_14px_rgba(217,164,65,0.2)] cursor-default">
